# Generated by Django 3.2.9 on 2021-11-17 10:22
...
def load_initial_data(apps, schema_editor):
    ...
    LegalGround.objects.bulk_create([
        LegalGround(name='1. Publieke taak'),
        LegalGround(name='2. Gerechtvaardigd belang'),
        LegalGround(name='3. Wettelijke verplichting'),
        LegalGround(name='4. Toestemming betrokkene(n)'),
        LegalGround(name='5. Uitvoering overeenkomst met betrokkene(n)'),
        LegalGround(name='6. Bescherming vitale belangen betrokkene(n) of van een andere natuurlijke persoon)'),
    ])
