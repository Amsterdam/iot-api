...
class TestMigrateApiData:
    ...
    def test_migrate_api_data_kentekencamera_milieuzone_only_insert_2(self, migrated_data):
        """
    ...
    def test_migrate_api_data_kenteken_milieuzone_1_insert_1_update(self, km_data, migrated_data):
        """
    ...
    def test_migrate_api_data_kenteken_milieuzone_1_update_1_delete(self, km_data, migrated_data):
        """
        call the migrate_api function twice with two different lists of sensors.
