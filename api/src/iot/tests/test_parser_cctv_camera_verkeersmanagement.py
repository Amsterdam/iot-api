...
class TestMigrateApiData:
    ...
    def test_migrate_api_data_cctvcv_only_insert_2(self, migrated_data):
        """
    ...
    def test_migrate_api_data_cctvcv_one_insert_one_update(self, cctvcv_data, migrated_data):
        """
    ...
    def test_migrate_api_data_cctvcv_one_update_one_delete(self, cctvcv_data, migrated_data):
        """
        call the migrate_api function twice with two different lists of sensors.
