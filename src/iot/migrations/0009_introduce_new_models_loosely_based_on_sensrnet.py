...
def load_initial_data(apps, schema_editor):
    ...
    Theme.objects.bulk_create([
        Theme(name="Economie: bouwen en verbouwen"),
        Theme(name="Economie: dienstensector"),
        Theme(name="Economie: marketing en reclame"),
        Theme(name="Economie: markttoezicht"),
        Theme(name="Milieu: afval"),
        Theme(name="Milieu: energie"),
        Theme(name="Milieu: geluid"),
        Theme(name="Milieu: klimaatverandering"),
        Theme(name="Milieu: natuur- en landschapsbeheer"),
        Theme(name="Milieu: stoffen"),
        Theme(name="Milieu: water, bodem, lucht"),
        Theme(name="Mobiliteit: auto"),
        Theme(name="Mobiliteit: fiets"),
        Theme(name="Mobiliteit: voetganger"),
        Theme(name="Mobiliteit: luchtvaart"),
        Theme(name="Mobiliteit: openbaar vervoer"),
        Theme(name="Mobiliteit: railverkeer"),
        Theme(name="Mobiliteit: scheepvaart"),
        Theme(name="Veiligheid: bewakings- en/of beveiligingscamera"),
        Theme(name="Veiligheid: gezondheid"),
    ])
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', django.contrib.postgres.fields.citext.CITextField(unique=True, verbose_name='Wettelijke grondslag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', django.contrib.postgres.fields.citext.CITextField(unique=True, verbose_name='Gebied')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', django.contrib.postgres.fields.citext.CITextField(unique=True, verbose_name='Thema')),
            ],
            options={
                'verbose_name': 'Thema',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', django.contrib.postgres.fields.citext.CITextField(unique=True, verbose_name='Kies soort / type sensor')),
                ('is_other', models.BooleanField(default=True, verbose_name='Anders, namelijk')),
            ],
            options={
                'verbose_name': 'Type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regions', models.ManyToManyField(blank=True, to='iot.Region', verbose_name='In welk gebied bevindt zich de mobiele sensor?')),
